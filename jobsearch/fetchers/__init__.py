...
BROWSER_FETCHERS = {
    ...
    "browser_eightfold": eightfold.fetch_browser,
    "browser_microsoft": microsoft.fetch_browser,
    "browser_bloomberg": bloomberg.fetch_browser,
    "browser_google": google.fetch_browser,
}
